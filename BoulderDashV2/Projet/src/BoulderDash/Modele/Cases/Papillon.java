...
public class Papillon extends Case {
	...
	/**
	 * 
	 * creates a papillon, initializes its position and its direction
	 *
	 */
	...
	// function that verifies its moves
	...
	/**
	 * destroys the papillon and make diamants appear instead
	 * 
	 */
	@Override
